...
const Project3 = () => {
    return (
        <section className='w-full mt-10'>
            <Title title="Projet 3" style="text-white text-center text-2xl mb-5" />
                    ...
                    <div className='w-32 '>
                        ...
                        <div className='flex flex-col justify-center items-center mt-7 gap-y-1'>
                            ...
                            <button className="btn btn-primary border px-3 lg:px-5 py-0.5 text-white text-nowrap  rounded-4xl ">
                                <Link href={"https://github.com/Young-power/whatsapp_ReactNative.git"} className='rounded-4xl' > Code disponible ici</Link>
                            </button>
                        </div>
